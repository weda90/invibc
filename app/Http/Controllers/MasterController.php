...
class MasterController extends Controller
{
    public function material(){
    	...
    	return view('master.material')->with('material_type',$material_type);
    }
...
*/
    public function company(){
        ...
        return view('master.company')->with('company_type',$company_type)->with('company_status',$company_status)->with('company_location',$company_location);
    }
