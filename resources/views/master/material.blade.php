        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">material</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <div class="row margin-bottom-20">
                        <div id="form_filter">
                            {{-- Begin Form --}}
                            {{ Form::open(array('url' => '', 'method' => 'POST', 'id'=>'', 'class'=>'', 'data-controller' => 'recv_material')) }}
                            {{-- {{ Form::create([‘method’ => ‘PUT’]) }} --}}
                            <div class="form-body">
                                <div class="form-group col-md-3">
                                     {{ Form::label('filter_mat_code', 'Code #', array('class'=>'control-label capitalize')) }}
                                     {{ Form::text('filter_mat_code', '' ,array('class'=>'form-control')) }}
                                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dt-responsive table-checkable" width="100%" id="datatable_ajax"  data-table="master/material">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="10%" class="desktop"> Size </th>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                         {{ Form::label('color', 'color', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                    ...
                    <div class="form-group">
                         {{ Form::label('size', 'size', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('size', null ,array('class'=>'form-control')) }}
                            </div>
                             <span class="help-block"> e.g: 1234567890 </span>
                        </div>
                    </div>
                    <div class="form-group">
