        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">receiving</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover dt-responsive table-checkable" width="100%" id="datatable_ajax"  data-table="stock/1">
                        <thead>
                ...
                {{-- Begin Form --}}
                {{ Form::open(array('url' => 'ajax/master/material', 'method' => 'POST', 'id'=>'form_sample_2', 'class'=>'form-horizontal', 'data-controller' => 'stock/1')) }}
                {{-- {{ Form::create([‘method’ => ‘PUT’]) }} --}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                         {{ Form::label('no_transc', 'No. BPB', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('no_transc', '' ,array('class'=>'form-control')) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('date_transc', 'Date', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-group input-small date date-picker" data-date-format="yyyy-mm-dd">
                                {{ Form::text('date_transc', '' ,array('class'=>'form-control','readonly'=>true)) }}
                           ...
                           {{--  <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('date_transc', '' ,array('class'=>'form-control date-picker')) }}
                            </div> --}}
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('no_bc', 'No BC', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('no_bc', null ,array('class'=>'form-control')) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('date_bc', 'Date BC', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-group input-small date date-picker" data-date-format="yyyy-mm-dd">
                                {{ Form::text('date_bc', '' ,array('class'=>'form-control','readonly'=>true)) }}
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
                                    </button>
                           ...
                           {{--  <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('date_bc', null ,array('class'=>'form-control')) }}
                            </div> --}}
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('code_mat', 'Code Material', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{-- <select class="form-control select2" name="code_mat" data-ajax="material">
                                </select> --}}
                                {{ Form::select('code_mat', array(), null, ['class' => 'form-control select2']) }}

                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('code_comp', 'Code Company', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                 {{-- <select class="form-control select2" name="code_comp">
                                </select> --}}
                                {{ Form::select('code_comp', array(), null, ['class' => 'form-control select2']) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('qty', 'qty', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-1">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('qty', null ,array('class'=>'form-control mask_decimal')) }}
                            </div>
                        </div>
                        {{ Form::label('unit_type', 'unit', array('class'=>'control-label col-md-1 capitalize')) }}
                         <div class="col-md-1">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <select class="form-control" name="unit_type">
                                    <option value="">Select...</option>
                                    @foreach($unit_type as $k => $v)
                    ...
                    <div class="form-group">
                         {{ Form::label('price', 'price', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-1">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('price', null ,array('class'=>'form-control mask_decimal')) }}
                            </div>
                        </div>
                        {{ Form::label('curr_type', 'curr', array('class'=>'control-label col-md-1 capitalize')) }}
                         <div class="col-md-1">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <select class="form-control" name="curr_type">
                                    <option value="">Select...</option>
                    ...
                    <div class="form-group">
                         {{ Form::label('no_inv', 'No Invoice', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('no_inv', null ,array('class'=>'form-control')) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('no_po', 'No PO', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('no_po', null ,array('class'=>'form-control')) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                         {{ Form::label('no_so', 'No SO', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                {{ Form::text('no_so', null ,array('class'=>'form-control')) }}
                            </div>
                        </div>
                    </div>
                   {{--  <div class="form-group">
                         {{ Form::label('remark', 'remark', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
