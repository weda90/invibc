        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">outgoing</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <div class="row margin-bottom-20">
                        <div id="form_filter">
                            {{-- Begin Form --}}
                            {{ Form::open(array('url' => '', 'method' => 'POST', 'id'=>'', 'class'=>'', 'data-controller' => 'stock/2')) }}
                    ...
                    <table class="table table-striped table-bordered table-hover dt-responsive table-checkable" width="100%" id="datatable_ajax"  data-table="stock/2">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th class="all" width="10%">No. BPPB</th>
                ...
                {{-- Begin Form --}}
                {{ Form::open(array('url' => 'ajax/master/material', 'method' => 'POST', 'id'=>'form_sample_2', 'class'=>'form-horizontal', 'data-controller' => 'stock/2')) }}
                {{-- {{ Form::create([‘method’ => ‘PUT’]) }} --}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                         {{ Form::label('no_transc', 'No. BPPB', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                    ...
                    <div class="form-group">
                        {{ Form::label('stock_to', 'To', array('class'=>'control-label col-md-3 capitalize')) }}
                         <div class="col-md-3">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <select class="form-control" name="stock_to">
                                    <option value="">Select...</option>
                                    @foreach($stock_to as $k => $v)
                                        <option value="{{ $k }}"> {{ $v }} </option>
                                    @endforeach
                                </select>
                            </div>
