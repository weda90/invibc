        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">BC 2.3</span>
                </div>
                <div class="actions">
                    {{-- <div class="btn-group">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover dt-responsive table-checkable" width="100%" id="datatable_ajax"  data-table="report/1">
                        <thead>
