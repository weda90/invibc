...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>INVIBC | @if(empty(Request::segments()))
                            {{ strtoupper('dashboard') }}
                        @else
                            {{ strtoupper(Request::segments()[0]) }}
                        @endif
        </title>
        ...
        <link href="{{ url('assets/layouts/layout5/css/custom.css') }}" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        @yield('script.page.level.plugins')
        <!-- END PAGE LEVEL PLUGINS -->
