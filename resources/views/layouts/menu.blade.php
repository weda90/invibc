<div class="nav-collapse collapse navbar-collapse navbar-responsive-collapse">
    <ul class="nav navbar-nav">
        <li class="dropdown dropdown-fw  @if(Request::is('/') OR Request::is('home/*') ) active open selected @endif">
            <a href="javascript:;" class="text-uppercase">
                <i class="icon-home"></i> Home </a>
            <ul class="dropdown-menu dropdown-menu-fw">
                <li @if(Request::is('/') OR Request::is('home/*') ) class="active" @endif>
                    <a href="{{ url('/') }}">
        ...
        <li class="dropdown dropdown-fw @if(Request::is('master/*')) active open selected @endif">
            <a href="javascript:;" class="text-uppercase">
                <i class="icon-puzzle"></i> Master </a>
            <ul class="dropdown-menu dropdown-menu-fw">
                <li @if(Request::is('master/material')) class="active" @endif>
                    <a href="{{ url('/master/material') }}">
                        <i class="icon-bar-chart"></i> Material </a>
                </li>
                <li @if(Request::is('master/company')) class="active" @endif>
